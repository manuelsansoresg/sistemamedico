...
<body class="bg-[#F8FAFC] text-[#1E293B]">
    <header class="w-full bg-[#27ADFA]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <nav class="space-x-3">
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center px-4 py-2 bg-white text-[#0061F5] font-bold rounded-md hover:bg-gray-100 transition-colors">Ir al Panel</a>
                @else
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div>
                <h2 class="text-5xl font-extrabold text-[#0061F5] mb-6 leading-tight">Gestión clínica para médicos</h2>
                <p class="text-lg text-[#1E293B] mb-8 max-w-xl">Administra citas, pacientes y expedientes de forma simple y segura. Diseñado para profesionales de la salud.</p>
                <ul class="space-y-3 mb-10">
                    <li class="flex items-center"><i class="fas fa-chevron-right text-[#0061F5] mr-3"></i>Agenda y horarios optimizados</li>
                    <li class="flex items-center"><i class="fas fa-chevron-right text-[#0061F5] mr-3"></i>Gestión de pacientes y equipo</li>
                    <li class="flex items-center"><i class="fas fa-chevron-right text-[#0061F5] mr-3"></i>Expedientes con filtros y descargas</li>
                </ul>
                @auth
            ...
            <div class="bg-white rounded-2xl shadow p-8 border border-gray-100 w-full">
                <div class="grid grid-cols-2 gap-8">
                    <a href="{{ route('login') }}" class="p-5 rounded-xl bg-blue-50 hover:bg-blue-100 transition flex items-center justify-between">
                        <div class="font-bold text-[#1E293B]">Citas</div>
                    ...
                    <a href="{{ route('login') }}" class="p-5 rounded-xl bg-blue-50 hover:bg-blue-100 transition flex items-center justify-between">
                        <div class="font-bold text-[#1E293B]">Pacientes</div>
                        <span class="w-9 h-9 rounded-full bg-white text-[#0061F5] flex items-center justify-center"><i class="fas fa-chevron-right"></i></span>
                    </a>
                    <a href="{{ route('login') }}" class="p-5 rounded-xl bg-blue-50 hover:bg-blue-100 transition flex items-center justify-between">
                        <div class="font-bold text-[#1E293B]">Expedientes</div>
                        <span class="w-9 h-9 rounded-full bg-white text-[#0061F5] flex items-center justify-center"><i class="fas fa-chevron-right"></i></span>
                    </a>
                    <a href="{{ route('login') }}" class="p-5 rounded-xl bg-blue-50 hover:bg-blue-100 transition flex items-center justify-between">
                        <div class="font-bold text-[#1E293B]">Clínicas</div>
                        <span class="w-9 h-9 rounded-full bg-white text-[#0061F5] flex items-center justify-center"><i class="fas fa-chevron-right"></i></span>
                    </a>
                </div>
            </div>
    ...
    <footer class="py-8 text-center text-sm text-gray-500">
        © {{ date('Y') }} {{ config('app.name', 'Sistema Médico') }} — Todos los derechos reservados.
    </footer>
</body>
</html>
