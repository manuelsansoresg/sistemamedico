        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-1"></i>
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">{{ __('users.breadcrumbs.create') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-2xl font-bold mb-6">{{ __('common.new_record') }}</h2>
                    ...
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    <label for="password" class="block text-sm font-bold text-gray-700">{{ __('users.fields.password') }}</label>
                            ...
                            <div class="mt-4 flex items-center">
                                ...
                                <label for="active" class="ml-2 text-sm text-gray-700">{{ __('common.active') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-8" x-data="{ selectedRole: '{{ old('role') }}' }">
                            ...
                            <div class="mb-6" x-show="['asistente', 'secretaria'].includes(selectedRole)" x-transition>
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ __('users.help.select_download_permissions') }}</p>
                            </div>
                            @endif
                        </div>
