                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('pacientes.update', $paciente) }}" method="POST">
                        ...
                        <div class="flex items-center space-x-6 mb-6">
                            <div class="flex items-center">
                                <input id="activo" type="checkbox" name="activo" value="1" {{ old('activo', $paciente->activo) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                <label for="activo" class="ml-2 text-sm font-medium text-gray-900">Activo</label>
                            </div>

                            <div class="flex items-center">
                                <input id="perfil_compartido" type="checkbox" name="perfil_compartido" value="1" {{ old('perfil_compartido', $paciente->perfil_compartido) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
