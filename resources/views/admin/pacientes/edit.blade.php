                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('pacientes.update', $paciente) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                <x-input-label for="fecha_nacimiento" :value="__('common.birth_date')" />
                            ...
                            <div>
                                ...
                                <select id="sexo" name="sexo" class="block mt-1 w-full border-gray-300 focus:border-[#0061F5] focus:ring-[#0061F5] rounded-md shadow-sm">
                                    ...
                                    <option value="M" {{ old('sexo', $paciente->sexo) == 'M' ? 'selected' : '' }}>{{ __('common.male') }}</option>
                                    <option value="F" {{ old('sexo', $paciente->sexo) == 'F' ? 'selected' : '' }}>{{ __('common.female') }}</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                <x-input-label for="password" :value="__('common.password').' ('.__('common.leave_blank').')'" />
