<x-admin-layout>
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-1"></i>
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">{{ __('consultorios.breadcrumbs.edit') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <script>
        function consultorioForm() {
            return {
                address: "{{ old('direccion', $consultorio->direccion) }}",
                lat: "{{ old('lat', $consultorio->lat) }}",
                lng: "{{ old('lng', $consultorio->lng) }}",
                map: null,
                marker: null,
                init() {
