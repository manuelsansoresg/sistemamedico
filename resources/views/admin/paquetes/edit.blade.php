                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nombre" id="nombre" value="{{ $paquete->nombre }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="precio" id="precio" value="{{ $paquete->precio }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="validar_cedula" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500" {{ $paquete->validar_cedula ? 'checked' : '' }}>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="activo" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500" {{ $paquete->activo ? 'checked' : '' }}>
