                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('plantillas.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Plantillas</a>
                        </div>
                    </li>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('plantillas.index') }}" class="text-gray-600 hover:text-blue-600 transition-colors">
                    ...
                    <form action="{{ route('plantillas.update', $plantilla) }}" method="POST" x-data="templateForm()">
                        ...
                        <div class="grid grid-cols-1 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $plantilla->nombre) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                            </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" :name="'campos[' + index + '][nombre]'" :id="'campo_nombre_' + index" x-model="campo.nombre" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required placeholder="Ej: Motivo de Consulta">
                                            </div>

                                            <!-- Tipo de Campo -->
                                            <div>
                                                <label :for="'campo_tipo_' + index" class="block text-sm font-medium text-gray-700">Tipo de Campo</label>
                                                <select :name="'campos[' + index + '][tipo]'" :id="'campo_tipo_' + index" x-model="campo.tipo" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                            ...
                                            <div class="col-span-full" x-show="campo.tipo === 'select'">
                                                ...
                                                <input type="text" :name="'campos[' + index + '][opciones]'" :id="'campo_opciones_' + index" x-model="campo.opciones" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Opción 1, Opción 2, Opción 3">
                                                <p class="text-xs text-gray-500 mt-1">Ingrese los valores separados por comas.</p>
                                            </div>

                                            <!-- Obligatorio -->
                                            <div class="flex items-center">
                                                <input type="checkbox" :name="'campos[' + index + '][es_obligatorio]'" :id="'campo_obligatorio_' + index" x-model="campo.es_obligatorio" value="1" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
