<x-admin-layout>
                            ...
                            <div class="space-y-6">
                                ...
                                <div x-show="transfer" x-transition class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="banco" id="banco" value="{{ old('banco') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    </div>

                                    <div>
                                        <label for="titular" class="block text-sm font-bold text-gray-700">Titular</label>
                                        <input type="text" name="titular" id="titular" value="{{ old('titular') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    </div>

                                    <div>
                                        <label for="cuenta" class="block text-sm font-bold text-gray-700">Cuenta</label>
                                        <input type="text" name="cuenta" id="cuenta" value="{{ old('cuenta') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    </div>

                                    <div>
                                        <label for="clabe" class="block text-sm font-bold text-gray-700">CLABE</label>
                                        <input type="text" name="clabe" id="clabe" value="{{ old('clabe') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            // Inicializar estado basado en old input si existe
            @if(old('aceptar_transferencia_bancaria'))
