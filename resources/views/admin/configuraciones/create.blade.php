                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('configuraciones.store') }}" method="POST">
                        ...
                        <div class="flex justify-end mt-8 gap-2">
                            <a href="{{ route('configuraciones.index') }}" class="px-4 py-2 bg-gray-500 text-white font-bold rounded-md hover:bg-gray-600 transition-colors">{{ __('common.buttons.cancel') }}</a>
                            <x-primary-button>
                                Guardar
                            </x-primary-button>
                        </div>
