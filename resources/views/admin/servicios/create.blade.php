        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-2xl font-bold mb-6">{{ __('servicios.create') }}</h2>
                    ...
                    <form action="{{ route('servicios.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="duracion" id="duracion" value="{{ old('duracion') }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#0061F5] focus:ring-[#0061F5]" required>
                            </div>

                            <div>
                                <label for="costo" class="block text-sm font-bold text-gray-700">{{ __('servicios.fields.cost') }}</label>
                                <input type="number" name="costo" id="costo" value="{{ old('costo') }}" min="0" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#0061F5] focus:ring-[#0061F5]" required>
                            </div>
                        </div>
