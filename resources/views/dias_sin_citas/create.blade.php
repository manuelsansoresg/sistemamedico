        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-1"></i>
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Nuevo Registro</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-800 mb-6">Registrar Día Sin Citas</h2>
                    ...
                    <form action="{{ route('dias-sin-citas.store') }}" method="POST" x-data="{ todoElDia: true }">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="text" name="motivo" id="motivo" class="mt-1 focus:ring-[#0061F5] focus:border-[#0061F5] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('motivo') }}" required placeholder="Ej: Puente laboral, Vacaciones, Mantenimiento">
                                @error('motivo')
                            ...
                            <div class="col-span-2">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 text-sm">
                                        <label for="todo_el_dia" class="font-medium text-gray-700">Todo el día</label>
                                        <p class="text-gray-500">Marcar si no habrá citas en todo el horario laboral.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Consultorios -->
                            <div class="col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Aplicar a Consultorios</label>
